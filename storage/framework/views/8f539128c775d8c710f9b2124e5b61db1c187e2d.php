              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number total-order-data"><strong style="color: #733686"><?php echo e(number_format((float)$total_sales, 0, '.', ' ')); ?></strong></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number delivered-data"><strong style="color: #00c689"><?php echo e(number_format((float)$livre, 0, '.', ' ')); ?></strong></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number in-progress-data"><strong style="color: #ff8952"><?php echo e(number_format((float)$en_cours, 0, '.', ' ')); ?></strong></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number in-progress-data"><strong style="color: red"><?php echo e(number_format((float)$returned, 0, '.', ' ')); ?></strong></div>
                  </div>
                </div>
              </div>
              <div class="row">
